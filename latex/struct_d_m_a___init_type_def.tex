...
Specifies the channel used for the specified stream. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___channel__selection}{D\+MA Channel selection}} ~\newline
...
Specifies if the data will be transferred from memory to peripheral, from memory to memory or from peripheral to memory. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___data__transfer__direction}{D\+MA Data transfer direction}} ~\newline
...
Specifies the F\+I\+FO threshold level. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___f_i_f_o__threshold__level}{D\+MA F\+I\+FO threshold level}} ~\newline
...
Specifies the Memory data width. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___memory__data__size}{D\+MA Memory data size}} ~\newline
...
Specifies whether the memory address register should be incremented or not. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___memory__incremented__mode}{D\+MA Memory incremented mode}} ~\newline
...
Specifies the Peripheral data width. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___peripheral__data__size}{D\+MA Peripheral data size}} ~\newline
...
Specifies whether the Peripheral address register should be incremented or not. This parameter can be a value of \mbox{\hyperlink{group___d_m_a___peripheral__incremented__mode}{D\+MA Peripheral incremented mode}} ~\newline
