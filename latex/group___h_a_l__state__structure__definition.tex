\hypertarget{group___h_a_l__state__structure__definition}{}\doxysection{H\+AL state structure definition}
...
Collaboration diagram for H\+AL state structure definition\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=319pt]{group___h_a_l__state__structure__definition}
\end{center}
\end{figure}
